...
import com.polygon.tags.routes.{DomainService, LoginService, Service}
...
class RoutingServer(implicit val system: ActorSystem,
                    ...
                    implicit val logger: LoggingAdapter) extends Service with LoginService with DomainService {
  def startServer(address: String, port: Int) = {
    val loggedRoute = requestMethodAndResponseStatusAsInfo(Logging.InfoLevel, routes ~ loginServiceRoute ~ domainServiceRoute)
